...
void CSkybox::Create(float size, std::string resourcesFilePath)
{

	m_cubemapTexture.Create(resourcesFilePath + "skyboxes/space/space_right.png", resourcesFilePath + "skyboxes/space/space_left.png",
		resourcesFilePath + "skyboxes/space/space_up.png", resourcesFilePath + "skyboxes/space/space_down.png",
		resourcesFilePath + "skyboxes/space/space_back.png", resourcesFilePath + "skyboxes/space/space_front.png");
